...
1. **Facebook Event URL** (optional): Add the link to your Facebook event
2. **Event Title** (required): Enter the event name
3. **Event Description**: Add details about the event (supports formatting)
4. **Event Date** (required): Select date and time
5. **Featured Image URL**: Paste the direct URL to an image
6. Click **Add Event**
...
- You can use Facebook event images directly (right-click and copy image URL)

### Event Descriptions
- Use the WordPress editor to format text (bold, italic, lists)
